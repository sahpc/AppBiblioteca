...
namespace AppBiblioteca.Controllers
{
    public class LibroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LibroId,Titulo,Genero,FechaPublicacion,Isbn")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LibroId,Titulo,Genero,FechaPublicacion,Isbn")] Libro libro)
        {
            if (id != libro.LibroId)
            {
                return NotFound();
